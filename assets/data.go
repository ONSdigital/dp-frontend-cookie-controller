...
// sources:
// templates/cookies-preference.tmpl (3.68kB)
// ../../../personal-projects/test-modules/render/Makefile (1.185kB)
// ../../../personal-projects/test-modules/render/assets/assets.go (139B)
// ../../../personal-projects/test-modules/render/assets/data.go (24.309kB)
// ../../../personal-projects/test-modules/render/assets/locales/active.cy.toml (23.49kB)
// ../../../personal-projects/test-modules/render/assets/locales/active.en.toml (22.601kB)
...
// ../../../personal-projects/test-modules/render/build/dp-render (226.692kB)
// ../../../personal-projects/test-modules/render/go.mod (1.04kB)
// ../../../personal-projects/test-modules/render/go.sum (9.389kB)
// ../../../personal-projects/test-modules/render/helpers.go (9.188kB)
...
// ../../../personal-projects/test-modules/render/render.go (2.055kB)
...
// templatesCookiesPreferenceTmpl reads file data from disk. It returns an error on failure.
func templatesCookiesPreferenceTmpl() (*asset, error) {
	path := "/Users/ravipradhan/Documents/ons/dp-frontend-cookie-controller/assets/templates/cookies-preference.tmpl"
	name := "templates/cookies-preference.tmpl"
...
// localesActiveCyToml reads file data from disk. It returns an error on failure.
func localesActiveCyToml() (*asset, error) {
	path := "/Users/ravipradhan/Documents/personal-projects/test-modules/render/assets/locales/active.cy.toml"
	name := "locales/active.cy.toml"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// localesActiveEnToml reads file data from disk. It returns an error on failure.
func localesActiveEnToml() (*asset, error) {
	path := "/Users/ravipradhan/Documents/personal-projects/test-modules/render/assets/locales/active.en.toml"
	name := "locales/active.en.toml"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"templates/cookies-preference.tmpl":                                          templatesCookiesPreferenceTmpl,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"locales": {nil, map[string]*bintree{
		"active.cy.toml": {localesActiveCyToml, map[string]*bintree{}},
		"active.en.toml": {localesActiveEnToml, map[string]*bintree{}},
	}},
	"templates": {nil, map[string]*bintree{
		"cookies-preference.tmpl": {templatesCookiesPreferenceTmpl, map[string]*bintree{}},
