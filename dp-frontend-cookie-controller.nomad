job "dp-frontend-cookie-controller" {
  ...
  group "web" {
    ...
    task "dp-frontend-cookie-controller" {
      ...
      artifact {
        source = "s3::https://s3-eu-west-1.amazonaws.com/{{DEPLOYMENT_BUCKET}}/dp-frontend-cookie-controller/{{REVISION}}.tar.gz"
      }

      config {
        command = "${NOMAD_TASK_DIR}/start-task"

        args = ["./dp-frontend-cookie-controller"]
